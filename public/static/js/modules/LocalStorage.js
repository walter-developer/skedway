    ...
    set(index, value = null) {
        try {
            ...
            if (keys.length > 0) {
                ...
                localStorage.setItem(first, JSON.stringify(lastValue));
                return true;
            }
            if (first) {
            ...
            console.log(e);
            alert('Erro ao adicionar dados em local storage!');
            return null;
        }
    }
    get(index, value = null) {
        try {
            ...
            if (localStorage.length > 0) {
                search = localStorage.getItem(first);
            ...
            console.log(e);
            alert('Erro ao listar dados em local storage!');
            return null;
        }
    }
    all() {
        try {
            ...
            console.log(e);
            alert('Erro ao listar todos os dados em local storage!');
            return null;
        }
    }
    delete(index) {
        try {
            ...
            console.log(e);
            alert('Erro ao deletar dados em local storage!');
            return null;
        }
    }
